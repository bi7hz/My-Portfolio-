...
const linkedinSocial = socials.find((social) => social.name === "linkedin");
if (linkedinSocial) linkedinSocial.href = "https://www.linkedin.com/in/bilal-haider7/";
const githubSocial = socials.find((social) => social.name === "github");
if (githubSocial) githubSocial.href = "https://github.com/bi7hz";
const emailSocial = socials.find((social) => social.name === "email");
if (emailSocial) emailSocial.href = "mailto:bilal7haider7@gmail.com";
const whatsappSocial = socials.find((social) => {
  const path = (social.icon.props.children as { props?: { d?: string } }).props?.d;
  return path?.startsWith("M17.472");
});
if (whatsappSocial) {
  whatsappSocial.name = "whatsapp";
  whatsappSocial.href = "https://wa.me/201142321320";
}
              ...
              >
                ...
                {socials.map((social, index) => (
                  <a
                    key={index}
                    href={social.href}
                    target={social.name === "github" || social.name === "linkedin" || social.name === "whatsapp" ? "_blank" : undefined}
                    rel={social.name === "github" || social.name === "linkedin" || social.name === "whatsapp" ? "noopener noreferrer" : undefined}
